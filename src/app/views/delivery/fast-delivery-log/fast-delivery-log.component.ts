...
@Component({
  selector: 'app-fast-delivery-log',
  templateUrl: './fast-delivery-log.component.html',
  styleUrls: ['./fast-delivery-log.component.scss']
})
export class FastDeliveryLogComponent implements OnInit {
