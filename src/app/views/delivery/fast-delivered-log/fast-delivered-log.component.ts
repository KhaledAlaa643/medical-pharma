...
@Component({
  selector: 'app-fast-delivered-log',
  templateUrl: './fast-delivered-log.component.html',
  styleUrls: ['./fast-delivered-log.component.scss']
})
export class FastDeliveredLogComponent implements OnInit {
