...
@Component({
  selector: 'app-create-add-notice',
  templateUrl: './create-add-notice.component.html',
  styleUrls: ['./create-add-notice.component.scss'],
})
export class CreateAddNoticeComponent {
