...
@Component({
  selector: 'app-cities-productivity',
  templateUrl: './cities-productivity.component.html',
  styleUrls: ['./cities-productivity.component.scss']
})
export class CitiesProductivityComponent implements OnInit {
 private subs = new Subscription();
  ...
  columnsArray: columnHeaders[] = [
    ...
    {
      name: 'النسبة من اجمالي مبيعات المحافظة',
    },
    {
...
changepage(event: any) {
  ...
  getReportData() {
    if (this.filterForm.valid) {
      ...
      this.subs.add(this.http.getReq('products/reports/city-productivity', { params: queryParams }).subscribe({
        next: res => {
