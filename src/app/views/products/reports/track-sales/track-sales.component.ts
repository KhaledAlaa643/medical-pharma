...
import { track } from '@models/pharmacie';
...
changepage(event: any) {
  ...
  getReportData() {
    if (this.filterForm.valid) {
      ...
      this.subs.add(this.http.getReq('products/reports/track-sales', { params: queryParams }).subscribe({
        next: res => {
  ...
  getTracks() {
    this.subs.add(this.generalService.getTracks().subscribe({
      next: (res) => {
        ...
        this.track_pharmacies_count_sum = res.additional_data.pharmacies_count_sum
