...
@Component({
  selector: 'app-inventored-products',
  templateUrl: './inventored-products.component.html',
  styleUrls: ['./inventored-products.component.scss']
})
export class InventoredProductsComponent implements OnInit {
  ...
  getAllData(filters: any,paginated: boolean) {
    ...
    let getUrl=''
    if (paginated) {
      getUrl = 'warehouses/inventory/carts/index';
      
      }
      else {
        getUrl = 'warehouses/inventory/carts/index/all';
      }
