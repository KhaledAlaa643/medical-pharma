...
@Component({
  selector: 'app-area-sales',
  templateUrl: './area-sales.component.html',
  styleUrls: ['./area-sales.component.scss']
})
export class AreaSalesComponent implements OnInit {
  ...
  footerData: any = [{orders_count_sum:'الاجمالي'}]
  page:number=1
  rows!:number
  total!:number
  submitFilterForm() {
