...
@Component({
  selector: 'app-productivity-of-track',
  templateUrl: './productivity-of-track.component.html',
  styleUrls: ['./productivity-of-track.component.scss']
})
export class ProductivityOfTrackComponent implements OnInit {
