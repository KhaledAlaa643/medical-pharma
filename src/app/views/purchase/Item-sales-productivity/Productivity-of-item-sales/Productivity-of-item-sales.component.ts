...
@Component({
  selector: 'app-Productivity-of-item-sales',
  templateUrl: './Productivity-of-item-sales.component.html',
  styleUrls: ['./Productivity-of-item-sales.component.scss']
})
export class ProductivityOfItemSalesComponent implements OnInit {
