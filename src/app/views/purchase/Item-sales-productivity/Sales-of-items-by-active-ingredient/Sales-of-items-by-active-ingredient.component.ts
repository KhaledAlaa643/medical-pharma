...
@Component({
  selector: 'app-Sales-of-items-by-active-ingredient',
  templateUrl: './Sales-of-items-by-active-ingredient.component.html',
  styleUrls: ['./Sales-of-items-by-active-ingredient.component.scss']
})
export class SalesOfItemsByActiveIngredientComponent implements OnInit {
