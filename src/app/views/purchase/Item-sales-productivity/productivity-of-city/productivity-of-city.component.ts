...
@Component({
  selector: 'app-productivity-of-city',
  templateUrl: './productivity-of-city.component.html',
  styleUrls: ['./productivity-of-city.component.scss']
})
export class ProductivityOfCityComponent implements OnInit {
