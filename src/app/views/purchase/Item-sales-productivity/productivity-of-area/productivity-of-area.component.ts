...
@Component({
  selector: 'app-productivity-of-area',
  templateUrl: './productivity-of-area.component.html',
  styleUrls: ['./productivity-of-area.component.scss']
})
export class ProductivityOfAreaComponent implements OnInit {
