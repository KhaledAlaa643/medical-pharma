...
@Component({
  selector: 'app-transferred-order-based',
  templateUrl: './transferred-order-based.component.html',
  styleUrls: [ './transferred-order-based.component.scss' ]
})

export class TransferredOrderBasedComponent implements OnInit, OnDestroy {
  ...
  getAllData(filters: any, paginated: boolean) {
    ...
    let getUrl = '';
    if (paginated) {
      getUrl = 'warehouses/transfers/orders'
    }
    else {
      getUrl = 'warehouses/transfers/orders/all'
    }
