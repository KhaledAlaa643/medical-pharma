...
@Component({
  selector: 'app-prohibited-batch',
  templateUrl: './prohibited-batch.component.html',
  styleUrls: ['./prohibited-batch.component.scss'],
})
export class ProhibitedBatchComponent implements OnInit, OnDestroy {
  ...
  columnsArray: columnHeaders[] = [
    { name: 'الصنف', sort: true, direction: null },
    { name: 'التاريخ والتشغيلة  المحظورة' },
    { name: 'تصنيع شركة', sort: true, direction: null },
    { name: ' الكاتب ' },
    { name: '   تاريخ   التسجيل ' },
    { name: 'رقم   المنشور  ' },
    { name: 'سبب المنشور ' },
          ...
          next: (res) => {
            ...
            res.data.forEach((element: any, index: number) => {
              this.prohibitedBatchData.push({
                ...
                manufacturer_name: element?.product?.manufacturing_type?.name,
